<template>
  <div class="w-[430px] h-[430px] relative origin-top-left">
    ...
    <div v-if="showTypeDropdown" class="w-40 h-36 left-[183px] top-[314px] absolute z-10">
      ...
      <div class="left-[55px] top-[25px] absolute justify-start text-2xl font-medium font-['Alibaba_PuHuiTi'] text-stone-700 cursor-pointer" @click.stop="selectType('热销')">热销</div>
      <div class="left-[55px] top-[90px] absolute justify-start text-2xl font-medium font-['Alibaba_PuHuiTi'] text-stone-700 cursor-pointer" @click.stop="selectType('新菜')">新菜</div>
  
      <div class="w-32 h-0 left-[12px] top-[70px] absolute outline outline-1 outline-offset-[-0.50px] outline-stone-300"></div>
